...
enum modes
{                                                //    To-Do list for 23.08
    MANUAL = 'm',                                //    0) Mode Switching
    TEST = 't'                                   //    1) struct refactoring(entering, initialization, etc.)
};                                               //    2) file splitting
                                                 //    3) doxygen
enum roots
{
...
// раздельная компиляция         // перед понедельником
// files                         // перед понедельником
// doxygen                       // сразу
// аргументы командной строки    // сразу (argc, argv)
// array struct
...
void TestMode ()
{
    ...
    UnitSample test[nTests] = {//     a     b     c     x1_exp   x2_exp   nRoots_exp    x1    x2    nRoots       TestNumber
                                    ...
                                    {{0,    0,   8},    { 0,     0,       NO_ROOTS},    {0,   0,    NO_ROOTS},     8},
